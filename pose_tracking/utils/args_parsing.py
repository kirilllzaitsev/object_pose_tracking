...
def get_parser():
    ...
    poseformer_args.add_argument(
        "--mt_use_render_token", action="store_true", help="Use token from rendering for pose confidence"
    )
    poseformer_args.add_argument(
    ...
    poseformer_args.add_argument(
        "--mt_n_layers_f_transformer", type=int, default=1, help="Number of layers in the Factor-transformer"
    )
    poseformer_args.add_argument(
        "--mt_kpt_spatial_dim",
        type=int,

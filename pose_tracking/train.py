...
from pose_tracking.config import DATA_DIR, PROJ_DIR, WORKSPACE_DIR
...
def parse_args():
    ...
    parser.add_argument("--do_overfit", action="store_true", help="Overfit setting")
...
class PoseCNN(nn.Module):
    def __init__(self):
        ...
        # self.modify_resnet50_first_conv(backbone)
    ...
    def modify_resnet50_first_conv(self, backbone):
...
def main():
    ...
    lr_scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=args.epochs // 4, gamma=0.5, verbose=False)
    ...
    train_share = 0.2 if args.do_overfit else 0.8
